...
public static void main(String [] args){
    ...
    if ((((speed - limit) * 100) / speed) > 10) {
        System.out.printf("You need to pay %.2f. \n", mtd.metod(limit, speed)); //when the exceeded amount of the user speed is higher than 10%, use 2 digit method and look for the following condition
        if ((((speed - limit) * 100) / speed) >= 10) {
        System.out.println("Your driver license is being taken away for " + mtd2.metod2(limit, speed) + " months." ); //When the exceeded amount of the user speed is greater than or equal to 10%, use method to print the given sentence after which you will make the number for 2 digits then look for the following condition
        }
